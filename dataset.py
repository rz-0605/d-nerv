...
class Dataset_DNeRV_UVG(Dataset):
    def __init__(self, args, transform_rgb, transform_keyframe=None):
        self.gt_base_dir = './UVG_1920x1080.256x320/gt'
        self.keyframe_base_dir = './UVG_1920x1080.256x320/keyframe/q{}'.format(args.keyframe_quality)
        self.transform_rgb = transform_rgb
        self.transform_keyframe = transform_keyframe

        vid_length_dict = collections.OrderedDict()
        with open('./UVG_1920x1080.256x320/annotation/video_length.json', 'r') as fp:
